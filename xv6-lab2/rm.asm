...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    106e:	50                   	push   %eax
    106f:	68 87 18 00 00       	push   $0x1887
    1074:	6a 02                	push   $0x2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    140a:	0f b6 80 54 1b 00 00 	movzbl 0x1b54(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1546:	75 25                	jne    156d <printf+0xff>
          s = "(null)";
    1548:	c7 45 f4 a0 18 00 00 	movl   $0x18a0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    160e:	a1 70 1b 00 00       	mov    0x1b70,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16d9:	a3 70 1b 00 00       	mov    %eax,0x1b70
}
    16de:	90                   	nop
    16df:	c9                   	leave  
    16e0:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    173a:	a1 70 1b 00 00       	mov    0x1b70,%eax
}
    173f:	c9                   	leave  
    1740:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1756:	a1 70 1b 00 00       	mov    0x1b70,%eax
    175b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    175e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1762:	75 23                	jne    1787 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1764:	c7 45 f0 68 1b 00 00 	movl   $0x1b68,-0x10(%ebp)
    176b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    176e:	a3 70 1b 00 00       	mov    %eax,0x1b70
    1773:	a1 70 1b 00 00       	mov    0x1b70,%eax
    1778:	a3 68 1b 00 00       	mov    %eax,0x1b68
    base.s.size = 0;
    177d:	c7 05 6c 1b 00 00 00 	movl   $0x0,0x1b6c
    1784:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17da:	a3 70 1b 00 00       	mov    %eax,0x1b70
      return (void*)(p + 1);
    ...
    if(p == freep)
    17e7:	a1 70 1b 00 00       	mov    0x1b70,%eax
